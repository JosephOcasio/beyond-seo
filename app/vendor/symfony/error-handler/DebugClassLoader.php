...
class DebugClassLoader
{
    ...
    public static function enable(): void
    {
        ...
        foreach ($functions as $function) {
            // If it's the Elementor autoloader, and the method is not public, skip registering / unregistering
            if (
                is_array($function) &&
                isset($function[0], $function[1]) &&
                $function[0] === 'Elementor\\Autoloader' &&
                $function[1] === 'autoload'
            ) {
                try {
                    ...
                    // If the method doesn't exist, fallback to unregister
                }
            }
